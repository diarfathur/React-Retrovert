...
class MyProfileSeller extends Component {
    render() {
        return (
            <div class="container">
                <h3 class="mt-0"><strong>{this.props.shopName}</strong></h3>
                <div class='row'>
                    <div class='col-12 col-md-4'>
                        <img src={this.props.avatar} class="align-self-start mb-3" width='100%' />
                    </div>
                    <div class="col-12 col-md-8">
                        <dl class="row">
                            ...
                            <dd class="col-sm-9">{this.props.deskripsiPenjual}</dd>
                        </dl>
                    </div>
                </div>
            </div>
...
export default connect (
    'username, shopName, contact, email, address, avatar, deskripsiPenjual',
    actions)
